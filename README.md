...
- Provide API's for the `Authorization`and `Token` entities
- Scope and permission handling within the sample client still unclear to me. I am basically waiting for some docs that might be written ;-).
- Provide a [ASP.NET Razor Page](https://docs.microsoft.com/en-us/aspnet/core/razor-pages/?view=aspnetcore-5.0&tabs=visual-studio) bases UI.
