...
{
  public class RoleWithCustomKeyApiTest : IntegrationWithCustomKeyContext
  {
    ...
    public RoleWithCustomKeyApiTest(IntegrationWithCustomKeyApplicationFactory<Testing> fixture)
      : base(fixture)
    { }
