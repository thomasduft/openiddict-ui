...
{
  public class AccountWithCustomKeyApiTest : IntegrationWithCustomKeyContext
  {
    public AccountWithCustomKeyApiTest(IntegrationWithCustomKeyApplicationFactory<Testing> fixture)
      : base(fixture)
    { }
    ...
    {
      // Arrange
      var email = "register@openiddict.com";
    ...
    public async Task GetAsync_UserReceived()
    {
      ...
      Assert.NotNull(model);
      Assert.Equal(user.Id.ToString(), model.Id);
