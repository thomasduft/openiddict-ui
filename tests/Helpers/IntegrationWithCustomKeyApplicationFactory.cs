...
{
  public class IntegrationWithCustomKeyApplicationFactory<TEntryPoint>
    : WebApplicationFactory<TEntryPoint> where TEntryPoint : class
  {
    ...
    {
      builder.UseEnvironment("TestingWithCustomKey");
    ...
    public void EnsureMigration(IServiceProvider sp)
    {
      ...
      {
        var logger = services
          .GetRequiredService<ILogger<IntegrationWithCustomKeyApplicationFactory<TEntryPoint>>>();
