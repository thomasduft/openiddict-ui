...
{
  public class IntegrationWithCustomKeyContext : IClassFixture<IntegrationWithCustomKeyApplicationFactory<Testing>>
  {
    private readonly IntegrationWithCustomKeyApplicationFactory<Testing> _factory;
    private readonly HttpClient _client;
    private readonly string _accessToken;

    protected IntegrationWithCustomKeyContext(IntegrationWithCustomKeyApplicationFactory<Testing> factory)
    {
      _factory = factory;
